...
void Avatar::draw() {
  ...
  DrawContext *ctx = new DrawContext(
      ...
      this->speechFont);
  ctx->setInfoText(this->infoText, this->infoFlushing);
  face->draw(ctx);
  delete ctx;
}
